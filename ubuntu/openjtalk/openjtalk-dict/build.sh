...
realname="open_jtalk_dic_utf_8"
pkgname="openjtalk-dict"
pkgver="1.11"

src_urls=""
src_urls="$src_urls https://jaist.dl.sourceforge.net/project/open-jtalk/Dictionary/open_jtalk_dic-1.11/open_jtalk_dic_utf_8-1.11.tar.gz?viasf=1"
